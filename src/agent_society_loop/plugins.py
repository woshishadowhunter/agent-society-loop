...
SOCIETY_MANIFESTS: tuple[PluginManifest, ...] = (
    ...
    PluginManifest(
        ...
        "agent_society_loop.postgres_storage",
    ...
    PluginManifest(
        ...
        "agent_society_loop.consolidation",
    ...
    PluginManifest(
        ...
        "agent_society_loop.deterministic",
    ...
    PluginManifest(
        ...
        "agent_society_loop.model_agents",
    ...
    PluginManifest(
        ...
        "agent_society_loop.worker_service",
    ...
    PluginManifest(
        ...
        "agent_society_loop.http_transport",
    ...
    PluginManifest(
        ...
        "agent_society_loop.workspace_tools",
    ...
    PluginManifest(
        ...
        "agent_society_loop.a2a_governance",
    ...
    PluginManifest(
        ...
        "agent_society_loop.publication",
    ...
    PluginManifest(
        ...
        "agent_society_loop.mneme_bridge",
